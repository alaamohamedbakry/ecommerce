            ...
            <div class="user-info-dropdown">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        ...
                        <a class="dropdown-item" href="{{ route('index') }}"><i class="fa-solid fa-house"></i> Site</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="left-side-bar">
        <div class="brand-logo">
            <a href="{{ route('showdashboard') }}">
                <img src="{{ asset('front/assets/images/icons/222.png') }}" alt="" class="dark-logo" />
            ...
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            <li><a href="{{ route('customers.create') }}">Customer form</a></li>
                            <li><a href="{{ route('categories.create') }}">Categories form</a></li>
                            <li><a href="{{ route('products.create') }}">products form</a></li>
                            <li><a href="{{ route('orders.create') }}">order form</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                        ...
                        <ul class="submenu">
                            <li><a href="{{ route('customers.index') }}">customers table</a></li>
                            <li><a href="{{ route('categories.index') }}">categories table</a></li>
                            <li><a href="{{ route('products.index') }}">products table</a></li>
                            <li><a href="{{ route('orders.index') }}">orders table</a></li>
                        </ul>
                    </li>
                    <li>
